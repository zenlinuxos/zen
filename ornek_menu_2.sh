...
############ MAIN()
 wait 5 "Şimdi aynı fonksiyonu 'live' parametresi ile çalıştıralım.. Ama hiçbir tuşa dokunmadan 5 saniye bekleyin lütfen.. "
  ...
  aAile=( "Anne" "Baba" "Cocuk" "Dede" )
    ...
    do
      clear
         MENU_Array  "aAile" "== Görevleri hatırlat == "  "live"
